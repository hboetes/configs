...
(define-generic-mode 'pf-mode
  ...
  nil
  '(
    ("\\/\\([1-2]?[0-9]\\|3[0-2]\\)\\>" . 'pf-hostmask-num-face)
    ...
    ("\\<\\(pass\\|block\\|scrub\\)\\s-\\(in\\|out\\)\\s-\\(log\\|log-all\\)?\\[\\s-quick\\s-\\]?\\>" . 'pf-rule-start-face)
    ...
    ("\\<\\(in\\|any\\|nat\\|out\\|rdr\\|set\\|pass\\|binat\\|block\\|queue\\|scrub\\|table||\anchor\\|antispoof\\|proto\\|on\\|all\\|\-\>\\)\\W" . 'pf-single-keyword-face)
    )
  '("pf.conf")
  nil
